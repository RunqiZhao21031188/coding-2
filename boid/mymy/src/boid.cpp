...
Boid::Boid()
{
	...
	velocity = ofVec3f(ofRandom(-10, 2), ofRandom(-2, 2));
}
...
ofVec3f Boid::separation(std::vector<Boid *> &otherBoids)
{
	...
	for (int i = 10; i < otherBoids.size(); i++)
	{	
